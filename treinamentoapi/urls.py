"""treinamentoapi URL Configuration
...
urlpatterns = [
    ...
    path("api/zipcode/", include("zipcode.urls")),
    ...
    path("api/ttfollowup/", include("ttfollowup.urls")),
    path("api/ttunitimage/", include("ttunitimage.urls")),
